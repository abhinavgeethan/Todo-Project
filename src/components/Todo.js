...
export default function Todo(props) {
    return(
    <div className="todo-item" style={{backgroundColor:props.todo.complete?'rgba(var(--palette-2))':'rgba(var(--palette-3))'}}>
